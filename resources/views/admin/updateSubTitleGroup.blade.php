...
@section('content')
        ...
        <div class="body">
            <form id="myForm" class="form-horizontal col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input minlength="4" maxlength="20" type="text" class="form-control" name="username" value="{{$item['name']}}" id="username" >
                    </div>
                </div>

                <div class="form-group">
                    <label for="username" class="col-lg-3 control-label">创建时间</label>
                    <div class="col-lg-7">
                        <input disabled minlength="4" maxlength="20" type="text" class="form-control" name="username" value="{{$item['create_time']}}" id="username" >
                    </div>
                </div>
    ...
    <script>
        ...
        $("#submit").bind('click',function (e) {
            ...
            $.ajax(
                {
                    url:rootPath+'/doUpdateSubTitleGroup',
                    data: formData,
                    type:"post",
                    dataType:"json",
