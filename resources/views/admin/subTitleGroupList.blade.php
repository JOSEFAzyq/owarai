...
@section('content')
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny tablet breakpoint footable-loaded" data-page-size="8">
                            ...
                            <tr>
                                ...
                                <th class="footable-visible footable-sortable">修改时间<span class="footable-sort-indicator"></span></th>
                            ...
                            @foreach($items as $group)
                                <tr style="display: table-row;" class="footable-even">
                                    <td class="footable-visible footable-first-column"><span class="footable-toggle"></span>{{$group->name}}</td>
                                    <td class="footable-visible">{{$group->create_time}}</td>
                                    <td class="footable-visible">{{$group->update_time}}</td>
                                    <td class="footable-visible footable-last-column"><a href="updateSubTitleGroup?id={{$group->id}}">修改</a>|<a class="delete" value="{{$group->id}}" href="#">删除</a></td>
                                </tr>
                            @endforeach
    ...
    <script>
        ...
        $(".delete").bind('click',function (e) {
            ...
            $.ajax(
                {
                    url:rootPath+'/deleteSubTitleGroup',
